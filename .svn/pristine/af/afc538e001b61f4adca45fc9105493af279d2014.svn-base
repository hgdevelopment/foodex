							...
							<div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly  class="form-control form-control-line" name="from_branch" value="{{$data['branch']}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="to_branch" id="to_branch" class="form-control form-control-line" >
                                            ...
                                            @foreach ($data['branchs'] as $element)
                                               @if($element->id!=Auth::guard('admin')->user()->branch)
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control form-control-line"  value="{{Auth::guard('admin')->user()->employee_name}}" readonly>
                                    </div>
                                </div>
							</div>							
						</div>
        ...
        .on('click', '.remove-product', function() {
            ...
            var $form = $(e.target),
             ...
             var form = $('#purchase_order_form')[0]; 
                     ...
                     $.ajax({
                            url: '{{URL::to('/') }}/admin/stock/request/send',
                            method: 'POST',
                            data: data,
