...
<body>
    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url(<?php echo e(URL::asset('img/back.jpg')); ?>)">        
            <div class="login-box card">
            <div class="card-block">
                <form class="form-horizontal form-material" id="loginform" method="post" action="<?php echo e(route('login')); ?>" >
                    <?php echo csrf_field(); ?>

                    <h2 style="text-align:center;color: #1E88E5"><strong>HEERA PURE DROPS</strong></h2><br><br>
