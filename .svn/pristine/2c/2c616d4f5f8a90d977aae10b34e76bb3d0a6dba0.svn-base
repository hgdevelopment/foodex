                        ...
                        <div class="p-20">
							...
							<tbody>
								...
								<?php $__currentLoopData = $view_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view_orders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($view_orders->total_paid_amount != $view_orders->total_amount): ?>
									<tr>
										<td><?php echo e($sl++); ?></td>
                                        ...
                                        <td><?php echo e($view_orders->total_paid_amount); ?></td>
                                        <td>
                                          <a href="<?php echo e(URL::to('/')); ?>/admin/updateAmount/<?php echo e($view_orders->orderId); ?>" class=""><button class="btn btn-success" type="button">Make Payment</button></a>
                                        </td>
									</tr>
                                    <?php endif; ?>
