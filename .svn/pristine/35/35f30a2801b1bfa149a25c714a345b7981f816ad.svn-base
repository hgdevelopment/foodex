  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card card-outline-info">
        ...
        <div class="card-body col-sm-12">
          <form action="{{URL::to('/') }}/admin/purchase/stock_upload" method="POST" id="stock"  enctype="multipart/form-data" data-parsley-validate class="m-t-40">
            <div class="form-body">
              {{csrf_field()}}
              <div class="row p-t-20">
                <div class="col-md-6">
...
<script type="text/javascript">
  ...
  //   //var data = new FormData(form);
  //   $.ajax({
  //       url: '{{URL::to('/') }}/admin/purchase/stock_upload',
  //       type: 'POST',
  //       data: data,
  //       dataType: "html",
  //       success: function (data) {
