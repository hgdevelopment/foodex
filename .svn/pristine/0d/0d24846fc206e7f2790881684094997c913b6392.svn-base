							...
							<tbody>
								...
								<?php $__currentLoopData = $view_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view_orders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
                                        ...
                                        <td>
                                          <a href="<?php echo e(URL::to('/')); ?>/admin/orderSales/<?php echo e($view_orders->orderId); ?>" style="cursor: pointer;"><img src="<?php echo e(URL::to('/')); ?>/img/print.png" title="print"></a>
                                          <a href="<?php echo e(URL::to('/')); ?>/admin/updateOrderConfirm/<?php echo e($view_orders->orderId); ?>" style="cursor: pointer;" title="Exchange"><img src="<?php echo e(URL::to('/')); ?>/img/ecchange.png"></a>
                                        </td>
									</tr>
