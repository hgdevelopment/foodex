									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<select class="form-control p-0" required  data-parsley-required-message="Select Mode" id="payment_type" name="payment_type" onclick="check_mode()">
												...
												<option id="normal" value="normal" <?php if($count>0 && $details->status=='normal'): ?><?php echo e('selected'); ?><?php endif; ?> >Normal</option>
								...
								<div class="col-md-2" id="cash_paid_div" style="display: none">
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<input type="text"   name="balance_amount" id="balance_amount" value="<?php echo e(isset($total_balance_amount) ? $total_balance_amount : 0); ?>">
											<input type="text"   name="total_paid_amount" id="total_paid_amount" value="<?php echo e(isset($total_paid_amount) ? $total_paid_amount : 0); ?>">  
