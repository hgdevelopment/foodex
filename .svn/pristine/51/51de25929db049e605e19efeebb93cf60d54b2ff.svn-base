		...
		<div class="col-12">
			<div class="card">
				<div class="card-block">
					...
					<form  class="floating-labels m-t-40" method="post" action="<?php echo e(URL::to('/')); ?>/admin/addUnits/<?php echo $__env->yieldContent('edit_id'); ?>" >
					<?php else: ?>
					<form class="floating-labels m-t-40" action="<?php echo e(URL::to('/')); ?>/admin/addUnits" method="post">
					<?php endif; ?>
						<?php echo csrf_field(); ?>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group m-b-40">
									<input type="text" class="form-control" id="unit_name" name="unit_name" value="<?php echo $__env->yieldContent('unit_name'); ?>">
									<span class="bar"></span>
