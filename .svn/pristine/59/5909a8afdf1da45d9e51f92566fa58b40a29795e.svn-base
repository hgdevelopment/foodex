									...
									<table class="table">
										...
										<tbody id="add_products">
											<tr class="hide" id="hidden_prodect">
												...
												<td>
													<input type="text" class="form-control form-control-line" name="qty[]" id="qty" style="width:60%;">
												</td>
												<td>
						...
						<table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo e($products->batch_id); ?></td>
...
<script>
	...
	// $('#damage_product_form').DataTable({
	// dom: 'Bfrtip',
	// columns: [
	// {data:'Branch', name: 'Branch'},
	// {data:'Batch Number',name:'Batch Number'}
