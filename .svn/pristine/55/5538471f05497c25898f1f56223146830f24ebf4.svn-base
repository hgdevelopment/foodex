							...
							<tbody>
								...
								@foreach ($view_order as $view_orders)
									<tr>
                                        ...
                                        <td>
                                        <a href="{{URL::to('/')}}/admin/updateOrderConfirm/{{ $view_orders->orderId }}"><input type="button" class="btn btn-success" value=" Order Sales"/></a>

                                        <a onclick="delete_product({{ $view_orders->orderId }});"><input type="button" class="btn btn-danger" value="Delete"/></a>
                                          </td>
									</tr>
								@endforeach
							</tbody>
