...
class updateOrderConfirmController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $type='Sales Request';
        $report='Update New Product In Sales Request .Bill Number: '. $request->bill_number . 'Added Product: '. $request->product_name;
    ...
    public function orderSales($id)
    {
        ...
        $type='Sales ';
        $report='product Sales & Take Print In Bill . Billnumber: '. $view_order->bill_number ;
        Controller::logReport($type,$report);
...

    {
        ...
        $type='sales Request';
        $report='Deleted Sales Request Product. Deleted Id: '. $id ;
        Controller::logReport($type,$report);
