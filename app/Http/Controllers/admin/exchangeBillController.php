...
class exchangeBillController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $type='Exchange';
        $report='Update Exchange Product In Sales Bill .Bill Number: '. $request->bill_number . 'Added Product: '. $request->product_name;
    ...
    public function update(Request $request, $userId)
    {
        ...
        $data=payment_mode::where('sales_id',$userId)->get()->toArray(); 

        DB::table('payment_modes_del')->insert($data);
        ...
        $type='Exchange';
        $report='Update Amount & Customer Details In Exchange Bill .Bill Number: '. $sales_order->bill_number ;
        Controller::logReport($type,$report);
    ...
    public function destroy(Request $request)
    {
        ...
        $sales_product = sales_product::where('id','=',$id)->first();
         $type='Exchange';
        $report='Return Sales Product . Sales Id: '. $id ;
        Controller::logReport($type,$report);
