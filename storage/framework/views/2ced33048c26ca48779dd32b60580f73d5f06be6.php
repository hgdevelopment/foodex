...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h2 class="text-themecolor m-b-0 m-t-0">View Order Confirm </h2>
        </div>
    </div>
							...
							<tbody>
								...
								<?php $__currentLoopData = $view_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view_orders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
                                        ...
                                        <td>
                                        <a href="<?php echo e(URL::to('/')); ?>/admin/updateOrderConfirm/<?php echo e($view_orders->orderId); ?>"><input type="button" class="btn btn-success" value=" Order Sales"/></a>

                                        <a onclick="delete_product(<?php echo e($view_orders->orderId); ?>);"><input type="button" class="btn btn-danger" value="Delete"/></a>
                                          </td>
									</tr>
