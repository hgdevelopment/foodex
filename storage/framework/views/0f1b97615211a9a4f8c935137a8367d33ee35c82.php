...
/*.bigdrop{
	...
	<form method="post" action="<?php echo e(URL::to('/')); ?>/admin/addOrder" data-parsley-validate class="m-t-40">
		<?php echo csrf_field(); ?> 
		<div class="container-fluid" style="margin-top:-30px">
			<div class="row">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<input type="text" readonly class="form-control form-control-line" name="bill_no" value="<?php echo e($billnumber); ?>" readonly="">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" id="bill_date" name="bill_date" required data-parsley-required-message= "Enter Sales Date" value="<?php echo e($date); ?>" readonly="">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="sales_person" value="<?php echo e($user_id); ?>" required data-parsley-required-message= "Enter Sales Person" readonly="">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="me_code" placeholder="ME Code" Name" required data-parsley-required-message= "Enter ME Code." data-parsley-trigger="keyup"  data-parsley-type="number">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="customer_name" required data-parsley-required-message= "Enter Customer Name" placeholder="CustomerName">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="customer_phone" required data-parsley-required-message= "Enter Customer Phone No." placeholder="CustomerNumber" data-parsley-trigger="keyup"  data-parsley-type="number">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<textarea  class="form-control form-control-line" name="customer_address" placeholder="Billing Address" required data-parsley-required-message= "Enter Customer Address."></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<textarea class="form-control form-control-line" name="shipping_address" placeholder="Shipping Address"></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="customer_gst_no" placeholder="Customer GST" required data-parsley-required-message= "Enter Customer GST No." data-parsley-trigger="keyup"  data-parsley-pattern="(?:\s*[a-zA-Z0-9]\s*)*">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="col-md-9">
					<div class="card card-outline-info">
						<div class="card-header">
							<h4 class="m-b-0 text-white">Bill Details (order Request)</h4>
						</div>
						<div class="card-block">
							<div class="row">
								...
								<table class="table">
									...
									<tbody id="add_products">
										<tr>
											...
											<td>
												<select  id="batch_no"  name="batch_no" style="width: 100%" class="chose">
...
<script src="<?php echo e(URL::asset('js/order.js')); ?>"></script>
