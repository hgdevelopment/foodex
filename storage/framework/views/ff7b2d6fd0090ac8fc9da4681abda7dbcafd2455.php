								...
								<div class="row col-md-12">
									...
									<div class="col-md-3">
										<div class="form-group m-b-40">
											...
											<input type="text" class="form-control" id="pin_number" name="pin_number" value="<?php echo $__env->yieldContent('pin_number'); ?>" required data-parsley-required-message="Please enter Address" data-parsley-trigger="keyup"  data-parsley-type="number">
									...
									<div class="col-md-3">
										<div class="form-group m-b-40">
											...
											<input type="text" class="form-control" id="phone_number" name="phone_number" value="<?php echo $__env->yieldContent('phone_number'); ?>" required data-parsley-required-message="Please enter Phone Number" data-parsley-trigger="keyup"  data-parsley-type="number">
