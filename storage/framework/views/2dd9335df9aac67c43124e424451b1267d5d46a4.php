...
<aside class="left-sidebar">
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                <?php if(Session::get('userType') == 'OI'): ?>
                ...
                <?php endif; ?>
                <?php if(Session::get('userType') == 'SE' || Session::get('userType') == 'RE' || Session::get('userType') == 'OI'): ?>
                <li>
                ...
                <?php endif; ?>
                <?php if(Session::get('userType') == 'SE' || Session::get('userType') == 'OI'): ?>
                <li>
                ...
                <?php endif; ?>
                <?php if(Session::get('userType') == 'OI' || Session::get('userType') == 'VN'): ?>
                <li>
                ...
                <?php endif; ?>
                <?php if(Session::get('userType') == 'VN' || Session::get('userType') == 'OI'): ?>
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        ...
                        <li><a href="<?php echo e(\URL::to('admin/stockReport/stockTransferReport')); ?>">Stock Transfer Report</a></li>
                    </ul>
                </li>
                <?php endif; ?>
            </ul>
