					...
					<div class="card card-outline-info">
						...
						<div class="card-block">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" id="bill_date" name="bill_date"  data-parsley-required-message= "Enter Sales Date" value="<?php echo e($date); ?>" readonly="">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="sales_person" value="<?php echo e($user_id); ?>"   readonly="">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
