                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo e(URL::asset('img/images/logo-icon.png')); ?>" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="<?php echo e(URL::asset('img/images/logo-light-icon.png')); ?>" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
