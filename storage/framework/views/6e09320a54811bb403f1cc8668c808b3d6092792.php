					...
					<div class="card card-outline-info">
						...
						<div class="card-block">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" id="bill_date" name="bill_date" value="<?php echo e($view_order->created_at->format('d-m-Y   H:i:s')); ?>" readonly="">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="sales_person" value="<?php echo e($sales_person->username); ?>"  readonly="" id="sales_person">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="me_code" id="me_code" placeholder="ME Code" Name"  data-parsley-trigger="keyup"  data-parsley-type="number" value="<?php echo e($view_order->me_code); ?>">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="customer_name"  id="customer_name"  placeholder="CustomerName" value="<?php echo e($view_order->customer_name); ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="customer_phone" id="customer_phone"  placeholder="CustomerNumber" data-parsley-trigger="keyup"  data-parsley-type="number" value="<?php echo e($view_order->customer_phone); ?>">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<textarea type="text"  class="form-control form-control-line" name="customer_address" id="customer_address" placeholder="CustomerAddress"  ><?php echo e($view_order->customer_address); ?></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="customer_gst_no" id="customer_gst_no" placeholder="Customer GST"  data-parsley-trigger="keyup"  data-parsley-pattern="(?:\s*[a-zA-Z0-9]\s*)*" value="<?php echo e($view_order->customer_gst); ?>">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								...
								<div class="col-md-2" id="cash_paid_div" style="display: none">
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text"  class="form-control form-control-line" name="paid_amount" id="paid_amount" value="<?php echo e(isset($pay_detail->paid_amount) ? $pay_detail->paid_amount : 0); ?>" data-parsley-trigger="keyup"  data-parsley-type="number"> 
										</div>
									</div>
								</div>
								...
								<div class="col-lg-12 col-xlg-12 col-md-12">
									<div class="form-group">
										<div class="col-sm-12">
											...
											<a href="<?php echo e(URL::to('/')); ?>/admin/orderSales/<?php echo e($pay_detail->sales_id); ?>" class="" id="sales"><input type="button" class="btn btn-success pull-left" style="margin-right:1%" value="Sales"></a>
										</div>
									</div>
								</div>
							</div>
...
$('.chose').on('select2:select', function (e) {		
    ...
    function(){
        window.open(link,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=400,height=1000');
         setTimeout(function() {
              window.location.href = "<?php echo e(URL::to('/')); ?>/admin/viewOrderConfirm"
            }, 2000);
    });
});
</script>
