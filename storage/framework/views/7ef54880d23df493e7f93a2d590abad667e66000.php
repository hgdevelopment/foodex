...
<script>
	$(function(){
       	$('#stock_request_send').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(URL::to('/')); ?>/admin/stock/datatable/request',
                    data: function (d) {
                        d.name = '';
        ...
        $('#stock_request_recieve').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '<?php echo e(URL::to('/')); ?>/admin/stock/datatable/recieve',
                    data: function (d) {
                        d.name = '';
                        // d.code = $('input[name=code]').val();
                        // d.usertype = $('select[name=usertype]').val();
        ...
        $('body').on('click','.view-request-recieve',function(e){
          e.preventDefault();
          window.location.href='<?php echo e(URL::to('/')); ?>/admin/stock/request/view/'+$(this).attr('data-id');
        });
