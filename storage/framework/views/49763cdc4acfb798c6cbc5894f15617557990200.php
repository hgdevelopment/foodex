...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h3 class="text-themecolor">Dashboard 13213</h3>
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-block">
                    <h4 class="card-title">Out Of Stock Productshjjjhjh</h4>
                        ...
                        <div class="card">
                          ...
                          <div id="nav-tabs">
                             <ul class="nav nav-tabs customtab"  role="tablist">
                                <li class="nav-item">
                                   <a class="nav-link <?php echo e(Request::segment(3) === '1' ? 'active' : null); ?> "  href="<?php echo e(URL::to('/')); ?>/admin/dashboard/1" role="tab">
