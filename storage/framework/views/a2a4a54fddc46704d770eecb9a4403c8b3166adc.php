...
<?php echo e(csrf_field()); ?>
								...
								<table class="table">
                                    ...
                                    <?php $__currentLoopData = $data_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>           
                                        <tr >
                                            ...
                                            <input type="text" class="form-control product" name="product[]" data-product-no="<?php echo e($element->product_number); ?>" data-product-id="<?php echo e($element->productId); ?>" readonly value="<?php echo e($element->product_name); ?>" />
                                            </td>
                                            <td>
    ...
    <input type="hidden" id="link" value="<?php echo e(URL::to('/')); ?>/admin/stock/transferStockPrint/">
</div>
<?php $__env->stopSection(); ?>
