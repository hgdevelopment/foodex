...
/*.bigdrop{
	...
	<form method="post" action="<?php echo e(URL::to('/')); ?>/admin/addSales" data-parsley-validate class="m-t-40">
		<?php echo csrf_field(); ?> 
					...
					<div class="card card-outline-info">
						...
						<div class="card-block">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<textarea type="text"  class="form-control form-control-line" name="customer_address" placeholder="CustomerAddress" required data-parsley-required-message= "Enter Customer Address."></textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="customer_gst_no" placeholder="Customer GST" required data-parsley-required-message= "Enter Customer GST No." data-parsley-trigger="keyup"  data-parsley-type="number">
									</div>
								</div>
							</div>
						</div>
