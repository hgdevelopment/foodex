...
/*.bigdrop{
	...
	<form method="post" action="<?php echo e(URL::to('/')); ?>/admin/salesBill/<?php echo e($view_order->sales_id); ?>" data-parsley-validate class="m-t-40" onsubmit="return validateForm()">
		<?php echo csrf_field(); ?> 
				...
				<div class="col-md-9">
					...
					<div class="card card-outline-info">
						<div class="card-header">
							...
							<input type="hidden" name="sales_id" id="sales_id" value="<?php echo e($id); ?>">
						</div>
					    <table class="table" id="stock_request_send" style="width: 100%">
					        ...
					        <tbody>
					            ...
					            <tr>
					                ...
					                <td><a onclick="(exchange_product(<?php echo e($details->sales_ids); ?>));" style="cursor: pointer;"><img src="<?php echo e(URL::to('/')); ?>/img/delete.png"></a></td>
...
<script src="<?php echo e(URL::asset('js/exchange.js')); ?>"></script>
...
$('.chose').on('select2:select', function (e) {		
	...
	function exchange_product(id) 
	{
        ...
        if (isConfirm) {
        $.ajax({
            url: "<?php echo e(URL::to('admin/exchangeBill/exchange_product')); ?>",
            type: "get",
            ...
            success: function (data) {
                ...
                setTimeout(function() {
              window.location.href = "<?php echo e(URL::to('/')); ?>/admin/exchange_product/"+sales_id
            }, 2000);
