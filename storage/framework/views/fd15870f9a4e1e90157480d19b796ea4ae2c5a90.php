                                        ...
                                        <td><div class="dropdown">
                                          <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false" style="border-color:#b1b4b7;background-color:#b1b4b7;">Action <span class="caret" ></span></button>
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="<?php echo e(URL::to('/')); ?>/admin/updateOrder/<?php echo e($view_orders->orderId); ?>/confirm_order" class=""><img src="https://png.icons8.com/task-completed/color/20/000000">Confirm   </a>
                                                </li>
                                                <li>
                                                    <a href="<?php echo e(URL::to('/')); ?>/admin/updateOrder/<?php echo e($view_orders->orderId); ?>" class=""><img src="https://png.icons8.com/edit/dusk/20/000000">Edit </a>
                                                </li>
                                            </ul>
                                        </div></td>
									</tr>
