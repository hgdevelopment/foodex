...
<div class="container-fluid">
    <div class="row page-titles">
        <div class="col-md-5 col-8 align-self-center">
            <h2 class="text-themecolor m-b-0 m-t-0">View Deleted Bils </h2>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="p-20">
							...
							<tbody>
								<?php $sl=1;?>
								<?php $__currentLoopData = $delete_order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $view_orders): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										<td><?php echo e($sl++); ?></td>
										<td><?php echo e(date('d-m-Y H:i:s',strtotime($view_orders->created_at))); ?></td>
										<td><?php echo e($view_orders->bill_number); ?></td>
										<td><?php echo e($view_orders->reason); ?></td>
									</tr>
