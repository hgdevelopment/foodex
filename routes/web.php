...
Route::group(['middleware' => ['admin']], function () 
{
    ...
    Route::get('admin/dashboard/{id}','admin\pageController@show');
    Route::resource('admin/expired', 'admin\dashboardController');
    ...
    Route::post('admin/purchase/stock_upload','admin\PurchaseController@stock_upload');
