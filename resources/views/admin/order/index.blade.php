...
/*.bigdrop{
	...
	<form method="post" action="{{URL::to('/') }}/admin/addOrder" data-parsley-validate class="m-t-40">
		{!! csrf_field() !!} 
					...
					<div class="card card-outline-info">
						...
						<div class="card-block">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" id="bill_date" name="bill_date" required data-parsley-required-message= "Enter Sales Date" value="{{ $date }}" readonly="">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="sales_person" value="{{ $user_id }}" required data-parsley-required-message= "Enter Sales Person" readonly="">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
