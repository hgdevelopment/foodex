...
/*.bigdrop{
	...
	<form method="post" action="{{URL::to('/') }}/admin/updateConfirm/{{$view_order->sales_id}}" data-parsley-validate class="m-t-40" >
		{!! csrf_field() !!} 
		{{ method_field('PUT') }}
					...
					<div class="card card-outline-info">
						...
						<div class="card-block">
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" id="bill_date" name="bill_date" value="{{ $view_order->created_at->format('d-m-Y   H:i:s') }}" readonly="">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="sales_person" value="{{ $sales_person->username }}"  readonly="" id="sales_person">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="me_code" id="me_code" placeholder="ME Code" Name"  data-parsley-trigger="keyup"  data-parsley-type="number" value="{{ $view_order->me_code}}">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="customer_name"  id="customer_name"  placeholder="CustomerName" value="{{ $view_order->customer_name}}">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="customer_phone" id="customer_phone"  placeholder="CustomerNumber" data-parsley-trigger="keyup"  data-parsley-type="number" value="{{ $view_order->customer_phone}}">
									</div>
								</div>
								<div class="col-md-12"><br></div>
								<div class="col-md-6">
									<div class="form-group">
										<textarea type="text"  class="form-control form-control-line" name="customer_address" id="customer_address" placeholder="CustomerAddress"  >{{ $view_order->customer_address}}</textarea>
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										<input type="text"  class="form-control form-control-line" name="customer_gst_no" id="customer_gst_no" placeholder="Customer GST"  data-parsley-trigger="keyup"  data-parsley-pattern="(?:\s*[a-zA-Z0-9]\s*)*" value="{{ $view_order->customer_gst}}">
									</div>
								</div>
							</div>
						</div>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											<select class="form-control p-0" required  data-parsley-required-message="Select Mode" id="payment_mode" name="payment_mode" onchange="payment_mode_change();">
												<option value="">Select</option>
												<option value="cash" @if($count>0 && $pay_detail->payment_mode=='cash'){{ 'selected' }}@endif id="1">Cash</option>
												<option value="card" @if($count>0 && $pay_detail->payment_mode=='card'){{ 'selected' }}@endif id="2">Card</option>
												<option value="credit" @if($count>0 && $pay_detail->payment_mode=='credit'){{ 'selected' }}@endif id="3">Credit</option>
												<option value="cheque" @if($count>0 && $pay_detail->payment_mode=='cheque'){{ 'selected' }}@endif  id="4">Cheque</option>
												<option value="online" @if($count>0 && $pay_detail->payment_mode=='online'){{ 'selected' }}@endif id="5">Online</option>
												<option value="both" @if($count>0 && $pay_detail->payment_mode=='both'){{ 'selected' }}@endif id="6">Both</option>
												<option value="charity"  @if($count>0 && $pay_detail->payment_mode=='charity'){{ 'selected' }}@endif id="7">Charity</option>
											</select>
										</div>
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-2" id="cash_paid_div" style="display: none">
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text"  class="form-control form-control-line" name="paid_amount" id="paid_amount" value="{{ $pay_detail->paid_amount or 0 }}" data-parsley-trigger="keyup"  data-parsley-type="number"> 
										</div>
									</div>
								</div>
								<div class="col-md-2" id="card_div" style="display: none">
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text"  class="form-control form-control-line" name="card" id="card" value="{{ $pay_detail->card_amount or 0 }}" data-parsley-trigger="keyup"  data-parsley-type="number" readonly="">
										</div>
									</div>
								</div>
								...
								<div class="col-md-2" id="transaction_div" style="display: none">
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text"  class="form-control form-control-line" name="transaction_no" id="transaction_no" value="{{ $pay_detail->transaction_number or 0 }}" data-parsley-trigger="keyup"  data-parsley-type="number">
										</div>
									</div>
								</div>
								<div class="col-md-2" id="reference_div" style="display: none">
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text"  class="form-control form-control-line" name="reference_no" id="reference_no" value="{{ $pay_detail->reference_number or 0 }}" data-parsley-trigger="keyup"  data-parsley-type="number">
										</div>
									</div>
								</div>
								<div class="col-md-2" id="cheque_div" style="display: none">
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text"  class="form-control form-control-line" name="cheque_no" id="cheque_no" value="{{ $pay_detail->cheque_number or 0 }}" data-parsley-trigger="keyup"  data-parsley-type="number">
										</div>
									</div>
								</div>
								<div class="col-md-2" id="account_div" style="display: none">
									<div class="form-group">
										...
										<div class="col-md-12">
											<input type="text"  class="form-control form-control-line" name="account_no" id="account_no" value="{{ $pay_detail->account_number or 0 }}" data-parsley-trigger="keyup"  data-parsley-type="number">
										</div>
									</div>
								</div>
							</div>
								...
								<div class="col-lg-12 col-xlg-12 col-md-12">
									<div class="form-group">
										<div class="col-sm-12">
											...
											<a href="{{URL::to('/')}}/admin/orderSales/{{ $pay_detail->sales_id}}" class="" id="sales"><input type="button" class="btn btn-success pull-left" style="margin-right:1%" value="Sales"></a>
										</div>
									</div>
								</div>
							</div>
...
<script src="{{ URL::asset('js/updateOrderConfirm.js')}}"></script>
...
$('.chose').on('select2:select', function (e) {		
	...
	function cancel_product(id) 
	{
        ...
        if (isConfirm) {
        $.ajax({
            url: "{{ URL::to('admin/updateOrderConfirm/cancel_product') }}",
            type: "get",
            ...
            success: function (data) {
                ...
                setTimeout(function() {
              window.location.href = "{{URL::to('/')}}/admin/updateOrderConfirm/"+sales_id
            }, 2000);
	...
	var total_amount = $("#paid_amount").val();
	if(payment_mode!='credit' && payment_mode!='charity'){
		if (total_amount == 0 || total_amount == '' )
		 {
		swal({title: "Enter Amount!",text: "Enter Paid Amount.",type: "info", timer: 3000});
		return false;
    ...
    function(){
        window.open(link,'targetWindow','toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=400,height=1000');
         setTimeout(function() {
              window.location.href = "{{URL::to('/')}}/admin/viewOrderConfirm"
            }, 2000);
    });
});
</script>
